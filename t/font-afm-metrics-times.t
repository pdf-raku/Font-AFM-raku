...
is-deeply $metrics.encode("RVX", :kern), [["R", 667.0, -80], ["VX", 1444.0, 0]], 'basic kerning';
is-deeply $metrics.encode("RVX", 12, :kern), [["R", 8.004, -0.96], ["VX", 17.328, 0]], 'basic kerning with stringwidth';
